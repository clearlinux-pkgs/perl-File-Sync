...
Requires: perl-File-Sync-lib
Requires: perl-File-Sync-license
Requires: perl-File-Sync-man
...
%package man
Summary: man components for the perl-File-Sync package.
Group: Default

%description man
man components for the perl-File-Sync package.
...
mkdir -p %{_topdir}/BUILD/File-Sync-0.11/deblicense/
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/perl-File-Sync
cp deblicense/copyright %{buildroot}/usr/share/doc/perl-File-Sync/deblicense_copyright
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/x86_64-linux-thread-multi/File/Sync.pm
/usr/lib/perl5/site_perl/5.26.1/x86_64-linux-thread-multi/auto/File/Sync/autosplit.ix

%files lib
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/x86_64-linux-thread-multi/auto/File/Sync/Sync.so

%files license
%defattr(-,root,root,-)
/usr/share/doc/perl-File-Sync/deblicense_copyright
